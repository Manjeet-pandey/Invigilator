...
SECRET_KEY = 'django-insecure-x=^#i54nwut#9#dg+3r4dtge9d*ny*ow(v6fi3vxu_kd0!v-0&'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = '075bct048.manjeet@pcampus.edu.np'
EMAIL_HOST_PASSWORD = 'Manjeet12'